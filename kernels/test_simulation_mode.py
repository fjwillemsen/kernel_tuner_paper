"""
This script is for obtaining the data for the simulation mode evaluation. 
It is based on the CLTune GEMM OpenCL kernel and relies on the presence of a bruteforced cachefile for this kernel.

It aims to answer the following questions:
Q1: Is the total process time of a real run within some margin of error relative to the simulated run?
Q2: Given a set amount of time on a tuning process, after the given amount of time has passed in both real and simulated mode, is the quality of found configurations the same within a margin of error?

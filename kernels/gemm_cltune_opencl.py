...
"""Tuning script to tune the CLTune GEMM OpenCL kernel. Based on https://github.com/CNugteren/CLBlast/blob/master/src/kernels/level3/xgemm_part1.opencl."""
...
def tune(inputs, device=0, searchspace_set=2):
